...
#include <stdint.h>                           /* Include standard types包含标准类型文件 */

#if defined (__ICCARM__)
  #include <intrinsics.h>                     /* IAR Intrinsics   iar的另一个数据类型版本*/
#endif


#ifndef __NVIC_PRIO_BITS
  #define __NVIC_PRIO_BITS    4               /*!< standard definition for NVIC Priority Bits 定义的nvic优先级使用了几位来定义*/
#endif
 ...
 *	对优先级进行解码，输入优先级分组，抢占优先级，子优先级，返回值就可以直接用到NVIC_SetPriority函数了
